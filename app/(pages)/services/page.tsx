...
const formules = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          "Optimisation SEO de base (titres, balises, mots-clés)",
          "Création et configuration de votre fiche Google Business",
          "1 mise à jour de contenu par mois",
        ],
      },
      {
        label: "Support",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "2 publications de contenu par mois (actualités, conseils)",
      ...
      },
      {
        label: "Support",
        items: [
          "Support téléphone + email (réponse sous 24 h)",
    ...
    sections: [
      {
        label: "Site web",
        items: [
          "8 pages sur mesure haut de gamme (dont pages villes et pages services dédiées)",
          "Design premium aux couleurs de votre entreprise",
          "Textes rédigés pour vous (Accueil + 2 pages de services) — inclus",
          "Formulaire de devis + section témoignages clients",
          "Galerie réalisations + section blog / actualités",
          "Site 100 % adapté mobile et tablette, vitesse optimisée",
          "Hébergement + nom de domaine inclus",
        ],
      },
      {
        ...
        items: [
          "SEO local multi-zones (jusqu'à 5 villes ciblées)",
          "Fiche Google Business créée, optimisée et animée",
          "4 publications de contenu par mois (articles, actualités, Google posts)",
          "Suivi de positionnement Google sur vos mots-clés (3 mois)",
      ...
      },
      {
        ...
        items: [
          "Support prioritaire téléphone + email (réponse sous 12 h)",
          "3 rounds de modifications après livraison",
          "Maintenance technique incluse 12 mois (mises à jour, sauvegardes)",
        ],
      },
    ],
  },
